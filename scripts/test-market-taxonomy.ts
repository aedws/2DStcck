...
assert.equal(companies.length, 86);
assert.deepEqual(
...
assert.equal(instrumentCounts.get("company"), 86);
assert.equal(instrumentCounts.get("etf"), 8);
assert.equal(instrumentCounts.get("strategy"), 364);
...
assert.equal(strategyCounts.get("레버리지"), 96);
assert.equal(strategyCounts.get("인버스"), 96);
assert.equal(strategyCounts.get("곱버스"), 96);
assert.equal(strategyCounts.get("커버드콜"), 76);
