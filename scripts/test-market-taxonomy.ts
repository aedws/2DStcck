...
assert.equal(companies.length, 53);
assert.deepEqual(
...
assert.equal(instrumentCounts.get("company"), 53);
assert.equal(instrumentCounts.get("etf"), 8);
assert.equal(instrumentCounts.get("strategy"), 243);
...
assert.equal(strategyCounts.get("레버리지"), 63);
assert.equal(strategyCounts.get("인버스"), 63);
assert.equal(strategyCounts.get("곱버스"), 63);
assert.equal(strategyCounts.get("커버드콜"), 54);
