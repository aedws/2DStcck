...
assert.equal(companies.length, 78);
assert.deepEqual(
...
assert.equal(instrumentCounts.get("company"), 78);
assert.equal(instrumentCounts.get("etf"), 8);
assert.equal(instrumentCounts.get("strategy"), 336);
...
assert.equal(strategyCounts.get("레버리지"), 88);
assert.equal(strategyCounts.get("인버스"), 88);
assert.equal(strategyCounts.get("곱버스"), 88);
assert.equal(strategyCounts.get("커버드콜"), 72);
