...
export const GLOBAL_SERVICE_NOTICE: ServiceNotice | null = {
  version: 7,
  emoji: "📢",
  title: "서버 불안정 보상 · 자산 복구 안내",
  body: [
    "이번 주 서버 불안정에 대한 보상으로 2026년 8월 14일 23:59:59(KST)까지 로그인한 모든 계정에 현금 $100M을 1회 지급합니다. 접속 후 서버 원장에서 자동 지급되며 별도 수령 버튼은 필요하지 않습니다.",
    "보상은 계정별 서버 수령 원장으로 관리되어 기기 변경·재접속·저장 재시도에도 중복 지급되지 않습니다. 운영 보상은 외부 현금 유입으로 분류되어 투자 수익률·시즌 성과를 부풀리지 않습니다.",
